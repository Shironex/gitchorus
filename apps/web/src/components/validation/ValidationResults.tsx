...
function getVerdictBadge(verdict: string): { label: string; className: string } {
  switch (verdict) {
    case 'confirmed':
      return { label: 'Confirmed', className: 'bg-green-500/20 text-green-700 dark:text-green-400 border-green-500/30' };
    case 'likely':
      return { label: 'Likely', className: 'bg-blue-500/20 text-blue-700 dark:text-blue-400 border-blue-500/30' };
    case 'uncertain':
      return { label: 'Uncertain', className: 'bg-yellow-500/20 text-yellow-700 dark:text-yellow-400 border-yellow-500/30' };
    case 'unlikely':
      return { label: 'Unlikely', className: 'bg-orange-500/20 text-orange-700 dark:text-orange-400 border-orange-500/30' };
    case 'invalid':
      return { label: 'Invalid', className: 'bg-red-500/20 text-red-700 dark:text-red-400 border-red-500/30' };
    default:
