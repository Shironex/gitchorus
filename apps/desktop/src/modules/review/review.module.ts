 ...
 * Review mode selection (single-agent vs multi-agent) is handled in the provider layer,
 * matching the pattern where ValidationModule does not import SettingsModule.
